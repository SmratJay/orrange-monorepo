...
// import { EnhancedDisputeService } from '../services/DisputeService'; // Disabled for now
...
export default async function adminRoutes(fastify: FastifyInstance) {
  ...
  // const disputeService = new EnhancedDisputeService(prisma, notificationService); // Disabled temporarily
  ...
  fastify.get('/disputes', {
    ...
    try {
      ...
      const result = 'Dispute service temporarily disabled'; // await disputeService.getDisputesDashboard(filters);
  ...
  fastify.get('/disputes/:tradeId', {
    ...
    try {
      ...
      const dispute = null; // await disputeService.getDisputeDetails(tradeId, user.id);
  ...
  fastify.post('/disputes/:disputeId/resolve', {
    ...
    try {
      ...
      const resolvedDispute = null; // Dispute service temporarily disabled
      // await disputeService.resolveDispute(disputeId, user.id, {
      //   ...resolution,
      //   resolvedBy: user.id
      // });
