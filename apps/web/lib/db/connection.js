...
var USE_SQLITE = !process.env.DATABASE_URL || process.env.NODE_ENV === 'development';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (USE_SQLITE) {
                            return [2 /*return*/, sqlite_1.sqliteDb.query(text, params)];
                        }
                        if (!this.pool)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (USE_SQLITE) {
                            return [2 /*return*/, sqlite_1.sqliteDb.transaction(callback)];
                        }
                        if (!this.pool)
                            throw new Error('PostgreSQL pool not initialized');
                        return [4 /*yield*/, this.pool.connect()];
